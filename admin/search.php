...
if(isset($_POST['id'])){
    ...
    $sql = "INSERT INTO sitin (student_id, laboratory, purpose) VALUES ('$student_id', '$laboratory', '$purpose')";
        ...
        <form action="" method="post" class="mt-10 p-5 border rounded-md grid grid-cols-3 gap-4">
            ...
            <div class="flex flex-col">
             ...
             <div class="flex flex-col">
                ...
                <div>
                    <input disabled type="text" name="sessions" value="<?php echo $student['sessions']?>" class="border rounded-md px-3 p-2"/>
                </div>
            </div> 
